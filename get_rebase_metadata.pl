#!/usr/bin/perl
#
#  Get metadata from rebase.
#  For each genome, outputs summary table.
#
use LWP::Simple;
use Data::Dumper;
...
print STDERR "Getting list $letter:\n";


my $page = get "http://tools.neb.com/~vincze/genomes/index.php?page=$letter";
...
my @as = $tree->look_down('_tag','a', sub { return $_[0]->attr('name')=~/^gn.*/; });
